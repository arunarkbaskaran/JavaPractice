...
public class BinaryGap {
	/*
	 * Task description A binary gap within a positive integer N is any maximal
	 * sequence of consecutive zeros that is surrounded by ones at both ends in the
	 ...
	 * 
	 * https://app.codility.com/demo/results/trainingUB4VEG-25H/
	 * Sample Output
	 * Finding BinaryGap for Number 1041 ... Binary Number For 1041 is 10000010001 BinaryGap : 5
	 */
	public static void main(String[] args) {
		int[] arr = { 1041, 9, 529, 20, 15, 32, 50000000, 1000000, 2147483647, -2147483648 };
		for (int i = 0; i < arr.length; i++) {
			System.out.println("Finding BinaryGap for Number " + arr[i] + " ... ");
			System.out.println("BinaryGap : " + solution(arr[i]));
		}
	...
	public static int solution(int N) {
		...
		System.out.println("Binary Number For " + N + " is " + binary);
